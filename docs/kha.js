...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "Sample", width : 800, height : 600},Main.init);
};
Main.init = function() {
	kha_Assets.loadEverything(function() {
		var sample = new Sample();
		kha_Scheduler.addTimeTask($bind(sample,sample.update),0,0.016666666666666666);
		kha_System.notifyOnRender($bind(sample,sample.render));
	});
};
Math.__name__ = true;
...
var Sample = function() {
	...
	structure.add("normal",kha_graphics4_VertexData.Float3);
	...
	this.pipeline.cullMode = kha_graphics4_CullMode.Clockwise;
	...
	var view = glm_GLM.lookAt(this2,this3,this4,this5);
	...
	dest5._00 = _a1._00 * _b1._00 + _a1._10 * _b1._01 + _a1._20 * _b1._02 + _a1._30 * _b1._03;
	dest5._10 = _a1._00 * _b1._10 + _a1._10 * _b1._11 + _a1._20 * _b1._12 + _a1._30 * _b1._13;
	dest5._20 = _a1._00 * _b1._20 + _a1._10 * _b1._21 + _a1._20 * _b1._22 + _a1._30 * _b1._23;
	dest5._30 = _a1._00 * _b1._30 + _a1._10 * _b1._31 + _a1._20 * _b1._32 + _a1._30 * _b1._33;
	dest5._01 = _a1._01 * _b1._00 + _a1._11 * _b1._01 + _a1._21 * _b1._02 + _a1._31 * _b1._03;
	dest5._11 = _a1._01 * _b1._10 + _a1._11 * _b1._11 + _a1._21 * _b1._12 + _a1._31 * _b1._13;
	dest5._21 = _a1._01 * _b1._20 + _a1._11 * _b1._21 + _a1._21 * _b1._22 + _a1._31 * _b1._23;
	dest5._31 = _a1._01 * _b1._30 + _a1._11 * _b1._31 + _a1._21 * _b1._32 + _a1._31 * _b1._33;
	dest5._02 = _a1._02 * _b1._00 + _a1._12 * _b1._01 + _a1._22 * _b1._02 + _a1._32 * _b1._03;
	dest5._12 = _a1._02 * _b1._10 + _a1._12 * _b1._11 + _a1._22 * _b1._12 + _a1._32 * _b1._13;
	dest5._22 = _a1._02 * _b1._20 + _a1._12 * _b1._21 + _a1._22 * _b1._22 + _a1._32 * _b1._23;
	dest5._32 = _a1._02 * _b1._30 + _a1._12 * _b1._31 + _a1._22 * _b1._32 + _a1._32 * _b1._33;
	dest5._03 = _a1._03 * _b1._00 + _a1._13 * _b1._01 + _a1._23 * _b1._02 + _a1._33 * _b1._03;
	dest5._13 = _a1._03 * _b1._10 + _a1._13 * _b1._11 + _a1._23 * _b1._12 + _a1._33 * _b1._13;
	dest5._23 = _a1._03 * _b1._20 + _a1._13 * _b1._21 + _a1._23 * _b1._22 + _a1._33 * _b1._23;
	dest5._33 = _a1._03 * _b1._30 + _a1._13 * _b1._31 + _a1._23 * _b1._32 + _a1._33 * _b1._33;
	this.mvp = dest5;
	var this13 = new kha_math_FastVector4();
	this13.x = 0;
	this13.y = 0;
	this13.z = 0;
	this13.w = 1;
	...
	dest8.w = 1;
	this.rotation = dest8;
	var raw = gltf_GLTF.parse(kha_Assets.blobs.Duck_gltf.toString());
	var this14 = new Array(1);
	var buffers = this14;
	buffers[0] = kha_Assets.blobs.Duck0_bin.bytes;
	var object = gltf_GLTF.load(raw,buffers);
	...
	var indices = object.meshes[0].primitives[0].getIndexValues();
	this.tex = kha_Assets.images.DuckCM;
	var numVerts = positions.length / 3 | 0;
	this.vertexBuffer = new kha_graphics4_VertexBuffer(numVerts,structure,kha_graphics4_Usage.StaticUsage);
	var vbData = this.vertexBuffer.lock();
	var _g1 = 0;
	var _g = numVerts;
	while(_g1 < _g) {
		var v = _g1++;
		vbData[v * structureLength] = positions[v * 3];
		vbData[v * structureLength + 1] = positions[v * 3 + 1];
		vbData[v * structureLength + 2] = positions[v * 3 + 2];
		vbData[v * structureLength + 3] = uvs[v * 2];
		vbData[v * structureLength + 4] = uvs[v * 2 + 1];
		vbData[v * structureLength + 5] = normals[v * 3];
...
Sample.prototype = {
	...
	,update: function() {
		var a = this.rotation;
		var y = -0.5 * Math.PI * 0.016666666666666666;
		...
		var bz = b.z;
		var bw = b.w;
		dest1.x = ax * bw + aw * bx + ay * bz - az * by;
		dest1.y = ay * bw + aw * by + az * bx - ax * bz;
		dest1.z = az * bw + aw * bz + ax * by - ay * bx;
		dest1.w = aw * bw - ax * bx - ay * by - az * bz;
		var rotation = this.rotation;
		var dest2 = this.model;
	...
	,render: function(frame) {
		var g = frame.get_g4();
		g.begin();
		g.clear(kha__$Color_Color_$Impl_$.fromFloats(0.33,0.33,0.33),1);
		...
		g.setMatrix(this.mID,this.model);
		g.setTexture(this.texID,this.tex);
	...
	while(_g7 < _g15.length) {
		...
		if(!(node.matrix == null && node.rotation == null && node.scale == null && node.translation == null)) {
			if(node.matrix != null) {
				...
				haxe_Log.trace("filling in matrix",{ fileName : "GLTF.hx", lineNumber : 188, className : "gltf.GLTF", methodName : "parse"});
...
var kha__$Assets_ImageList = function() {
	this.names = ["DuckCM"];
	this.DuckCMDescription = { files : ["DuckCM.png"], original_height : 512, type : "image", original_width : 512, name : "DuckCM"};
	this.DuckCMName = "DuckCM";
	this.DuckCM = null;
};
...
kha__$Assets_ImageList.prototype = {
	DuckCM: null
	,DuckCMName: null
	,DuckCMDescription: null
	,DuckCMLoad: function(done) {
		kha_Assets.loadImage("DuckCM",function(image) {
			done();
		});
	}
	,DuckCMUnload: function() {
		this.DuckCM.unload();
		this.DuckCM = null;
	}
	,names: null
...
var kha__$Assets_BlobList = function() {
	this.names = ["Duck_gltf","Duck0_bin","sphere_bin","suzanne_bin","sphere_gltf","suzanne_gltf"];
	this.suzanne_gltfDescription = { files : ["suzanne.gltf"], type : "blob", name : "suzanne_gltf"};
	this.suzanne_gltfName = "suzanne_gltf";
	this.suzanne_gltf = null;
	this.sphere_gltfDescription = { files : ["sphere.gltf"], type : "blob", name : "sphere_gltf"};
	this.sphere_gltfName = "sphere_gltf";
	this.sphere_gltf = null;
	this.suzanne_binDescription = { files : ["suzanne.bin"], type : "blob", name : "suzanne_bin"};
	this.suzanne_binName = "suzanne_bin";
	this.suzanne_bin = null;
	this.sphere_binDescription = { files : ["sphere.bin"], type : "blob", name : "sphere_bin"};
	this.sphere_binName = "sphere_bin";
	this.sphere_bin = null;
	this.Duck0_binDescription = { files : ["Duck0.bin"], type : "blob", name : "Duck0_bin"};
	this.Duck0_binName = "Duck0_bin";
	this.Duck0_bin = null;
	this.Duck_gltfDescription = { files : ["Duck.gltf"], type : "blob", name : "Duck_gltf"};
	this.Duck_gltfName = "Duck_gltf";
	this.Duck_gltf = null;
};
...
kha__$Assets_BlobList.prototype = {
	Duck_gltf: null
	,Duck_gltfName: null
	,Duck_gltfDescription: null
	,Duck_gltfLoad: function(done) {
		kha_Assets.loadBlob("Duck_gltf",function(blob) {
			done();
		});
	}
	,Duck_gltfUnload: function() {
		this.Duck_gltf.unload();
		this.Duck_gltf = null;
	}
	,Duck0_bin: null
	,Duck0_binName: null
	,Duck0_binDescription: null
	,Duck0_binLoad: function(done) {
		kha_Assets.loadBlob("Duck0_bin",function(blob) {
			done();
		});
	}
	,Duck0_binUnload: function() {
		this.Duck0_bin.unload();
		this.Duck0_bin = null;
	}
	,sphere_bin: null
	,sphere_binName: null
	,sphere_binDescription: null
	,sphere_binLoad: function(done) {
		kha_Assets.loadBlob("sphere_bin",function(blob) {
			done();
		});
	}
	,sphere_binUnload: function() {
		this.sphere_bin.unload();
		this.sphere_bin = null;
	}
	,suzanne_bin: null
	,suzanne_binName: null
	,suzanne_binDescription: null
	,suzanne_binLoad: function(done) {
		kha_Assets.loadBlob("suzanne_bin",function(blob) {
			done();
		});
	}
	,suzanne_binUnload: function() {
		this.suzanne_bin.unload();
		this.suzanne_bin = null;
	}
	,sphere_gltf: null
	,sphere_gltfName: null
	,sphere_gltfDescription: null
	,sphere_gltfLoad: function(done) {
		kha_Assets.loadBlob("sphere_gltf",function(blob) {
			done();
		});
	}
	,sphere_gltfUnload: function() {
		this.sphere_gltf.unload();
		this.sphere_gltf = null;
	}
	,suzanne_gltf: null
	,suzanne_gltfName: null
	,suzanne_gltfDescription: null
	,suzanne_gltfLoad: function(done) {
		kha_Assets.loadBlob("suzanne_gltf",function(blob) {
			done();
		});
	}
	,suzanne_gltfUnload: function() {
		this.suzanne_gltf.unload();
		this.suzanne_gltf = null;
	}
	,names: null
...
kha_Shaders.simple_fragData0 = "s775:";
kha_Shaders.simple_fragData1 = "s732:";
kha_Shaders.simple_fragData2 = "s736:";
kha_Shaders.simple_vertData0 = "s452:";
kha_Shaders.simple_vertData1 = "s538:";
kha_Shaders.simple_vertData2 = "s498:";
